...
// Recrie o desafio da palestra 'Looping Arrays, Breaking and Continuing',
// mas desta vez usando um loop while (chame a matriz 'percentages3')

// Reflita sobre a solução que você mais gosta para esta tarefa: o loop for ou o while
// ciclo?
const percentagens3 = [];

let i = 0;
while (i < populations.length) {
  percentagens3.push(percentageOfWorld3(populations[i]).toFixed(2));
  i += 1;
}

console.log(percentagens3);
